              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <small>Please fill all the required details</small>
                  </div>
                  <form action="<?php echo base_url('vendor/save_package'); ?>" id="packageForm" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                  ...
                  <div class="card-action" align="right">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url('vendor/manage_package'); ?>">Cancel</a>
                  </div>
                  </form>
                </div>
              </div>
