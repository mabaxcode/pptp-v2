...
<head>
  ...
  <title>Gallery - TravelTime Bootstrap Template</title>
  ...
  <main class="main">
          ...
          <div class="swiper init-swiper">
            ...
            <div class="swiper-wrapper">
              <?php foreach ($gallery as $image) { ?>
                <!-- why clicked at the latest one image by default ? -->
              <div class="swiper-slide">
                <div class="gallery-item">
                  <div class="gallery-img">
                    <a class="glightbox" data-gallery="images-gallery" href="<?php echo base_url($image['image']); ?>">
                      <img src="<?php echo base_url($image['image']); ?>" class="img-fluid" alt="">
    ...
    <section id="gallery" class="gallery section">
      ...
      <div class="container">
        ...
        <?php $no = 1; foreach ($gallery as $image2) { ?>
            ...
            <?php 
                ...
                ?>
          <div class="gallery-item <?php echo $featured_class; ?>">
            <a class="glightbox" data-gallery="images-gallery" href="<?php echo base_url($image2['image']); ?>">
              <img src="<?php echo base_url($image2['image']); ?>" class="img-fluid" alt="">
              <div class="gallery-overlay">
          ...
          <!-- <div class="gallery-item featured">
            <a class="glightbox" data-gallery="images-gallery" href="<?php echo base_url(); ?>assets2/img/gallery/gallery-1.webp">
              <img src="<?php echo base_url(); ?>assets2/img/gallery/gallery-1.webp" class="img-fluid" alt="">
              <div class="gallery-overlay">
                <i class="bi bi-plus-lg"></i>
              </div>
            </a>
        ...
        <div class="text-center mt-5">
          <a href="#" class="btn-view-more">View More <i class="bi bi-arrow-right"></i></a>
        </div>
