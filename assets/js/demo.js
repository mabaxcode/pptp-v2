...
$.ajax({
    // url: "<?php echo base_url('dashboard/booking_statistics'); ?>",
	url: base_url + "dashboard/booking_statistics",
	// url: "http://localhost/pptp/dashboard/booking_statistics",
    type: "GET",
    dataType: "json",
    success: function(response) {
        ...
        // Optional: custom legend rendering
